...
def generate_data():
    ...
    booths = [
        # Alambagh (south Lucknow, near UPSRTC bus terminal)
        {"id": 1,  "name": "Alambagh - Primary School Room No. 1",       "voters": 578, "lat": 26.8128, "lon": 80.9012, "hv": 0.0734, "hm": 0.1692},
        {"id": 2,  "name": "Alambagh - Primary School Room No. 2",       "voters": 577, "lat": 26.8141, "lon": 80.9025, "hv": 0.0806, "hm": 0.2291},
        # Singar Nagar (west of Alambagh)
        {"id": 3,  "name": "Singar Nagar - Junior High School East Wing", "voters": 657, "lat": 26.8092, "lon": 80.8945, "hv": 0.0783, "hm": 0.1604},
        {"id": 4,  "name": "Singar Nagar - Junior High School West Wing", "voters": 641, "lat": 26.8078, "lon": 80.8930, "hv": 0.0796, "hm": 0.1638},
        # Krishna Nagar (north-east of Alambagh)
        {"id": 5,  "name": "Krishna Nagar - Inter College Central Room",  "voters": 511, "lat": 26.8210, "lon": 80.9070, "hv": 0.0789, "hm": 0.2115},
        {"id": 6,  "name": "Krishna Nagar - Government School North Hall","voters": 543, "lat": 26.8222, "lon": 80.9082, "hv": 0.0723, "hm": 0.2085},
        # Cantonment Area (east Lucknow, British-era cantonment zone)
        {"id": 7,  "name": "Cantt Area - Community Hall Room No. 1",     "voters": 535, "lat": 26.8115, "lon": 80.9531, "hv": 0.1003, "hm": 0.4065},
        {"id": 8,  "name": "Cantt Area - Primary School Room No. 1",     "voters": 523, "lat": 26.8130, "lon": 80.9548, "hv": 0.1031, "hm": 0.4152},
        # Sadar Bazar (near Hazratganj market district)
        {"id": 9,  "name": "Sadar Bazar - Primary School Room No. 2",   "voters": 587, "lat": 26.8498, "lon": 80.9462, "hv": 0.0724, "hm": 0.0424},
        {"id": 10, "name": "Sadar Bazar - Junior High School East Wing", "voters": 616, "lat": 26.8510, "lon": 80.9478, "hv": 0.0713, "hm": 0.0403},
        # Charbagh (Lucknow railway station area)
        {"id": 11, "name": "Charbagh - Junior High School West Wing",    "voters": 616, "lat": 26.8313, "lon": 80.9180, "hv": 0.0653, "hm": 0.0434},
        {"id": 12, "name": "Charbagh - Inter College Central Room",      "voters": 610, "lat": 26.8325, "lon": 80.9195, "hv": 0.0664, "hm": 0.0278},
        # Nilmatha (east Lucknow)
        {"id": 13, "name": "Nilmatha - Government School North Hall",    "voters": 554, "lat": 26.8050, "lon": 80.9450, "hv": 0.1012, "hm": 0.4107},
        {"id": 14, "name": "Nilmatha - Community Hall Room No. 1",       "voters": 549, "lat": 26.8062, "lon": 80.9465, "hv": 0.1023, "hm": 0.4144},
        # Amausi (near Chaudhary Charan Singh Airport, south-west)
        {"id": 15, "name": "Amausi - Primary School Room No. 1",         "voters": 582, "lat": 26.7645, "lon": 80.8878, "hv": 0.0772, "hm": 0.1375},
    ]
